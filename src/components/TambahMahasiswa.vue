        ...
        <div class="card shadow">
            ...
            <form @submit.prevent="submitForm" class="bg-light p-4 rounded shadow-sm">
                <div class="mb-3">
                    ...
                    <input v-model="mahasiswa.nim" type="text" id="nim" class="form-control" required />
                </div>
                <div class="mb-3">
                    <label for="nama_lengkap" class="form-label">Nama Lengkap</label>
                    <input v-model="mahasiswa.nama_lengkap" type="text" id="nama_lengkap" class="form-control"
                        required />
                </div>
                <div class="mb-3">
...
export default {
    ...
    methods: {
        submitForm() {
            axios.post('http://localhost:8000/api/mahasiswa/tambah', this.mahasiswa)
                .then(response => {
                    this.$router.push('/');
                })
                .catch(error => {
